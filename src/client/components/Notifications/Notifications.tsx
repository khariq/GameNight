...
import { Container, Button, Feed, Icon } from 'semantic-ui-react';

interface INotificationsBarProperties {

}

export default class NotificationsBar extends React.Component<INotificationsBarProperties, {}> {
				...
				<div style={this.feedStyle}>
					<Feed>
						<Feed.Event>
							...
							<Feed.Content>
								<Feed.Summary>
									<Feed.User>Elliot Fu</Feed.User> added you as a friend<br />
